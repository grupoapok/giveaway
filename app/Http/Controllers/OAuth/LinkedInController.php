    ...
    function share() {
        ...
        try {
            ...
            if ($e->getResponse()->getStatusCode() == 401){
                return response([
                    "goto" => "https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=".env("LINKED_IN_API_KEY")."&redirect_uri=".route("linkedin.callback")."&scope=r_liteprofile%20r_emailaddress%20w_member_social"
                ], 401);
            }
        }
