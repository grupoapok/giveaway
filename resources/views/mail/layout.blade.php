...
<body style="background-color:#EFF7FB;">
  <div style="background-color:#EFF7FB;">
    ...
    <!--[if mso | IE]>
      ...
      <![endif]-->
    <div style="background:url(https://www.grupoapok.com/mail/layout/bgs/header.jpg) top center / auto no-repeat;margin:0px auto;max-width:600px;">
    ...
    <!--[if mso | IE]>
      ...
      >
        ...
        <v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
    <div style="background:url(https://www.grupoapok.com/mail/layout/bgs/footer.jpg) top center / auto no-repeat;margin:0px auto;max-width:600px;">
      <div style="line-height:0;font-size:0;">
        <table align="center" background="https://www.grupoapok.com/mail/layout/bgs/footer.jpg" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url(https://www.grupoapok.com/mail/layout/bgs/footer.jpg) top center / auto no-repeat;width:100%;">
          <tbody>
            <tr>
              <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                <!--[if mso | IE]>
